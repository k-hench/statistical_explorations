...
#> [16] tidygraph_1.2.0      glue_1.6.2           patchwork_1.1.0.9000
#> [19] prismatic_1.0.0.9000 forcats_0.5.1        stringr_1.4.0       
#> [22] dplyr_1.0.8          purrr_0.3.4          readr_1.4.0         
#> [25] tidyr_1.2.0          tibble_3.1.6         ggplot2_3.3.5       
#> [28] tidyverse_1.3.0.9000
#> 
#> loaded via a namespace (and not attached):
#>   [1] readxl_1.3.1         backports_1.2.1      plyr_1.8.6          
#>   [4] igraph_1.2.11        svUnit_1.0.6         splines_4.0.3       
...
#>  [19] RcppParallel_5.0.2   matrixStats_0.61.0   xts_0.12.1          
#>  [22] prettyunits_1.1.1    colorspace_2.0-3     rvest_1.0.0         
#>  [25] ggrepel_0.9.1        ggdist_3.0.1         haven_2.3.1         
#>  [28] xfun_0.29            callr_3.6.0          crayon_1.5.0        
#>  [31] jsonlite_1.8.0       lme4_1.1-26          zoo_1.8-8           
...
#>  [43] DBI_1.1.2            miniUI_0.1.1.1       gridtext_0.1.4      
...
#>  [64] tidyselect_1.1.2     rlang_1.0.1          reshape2_1.4.4      
...
#>  [82] mime_0.12            projpred_2.0.2       xml2_1.3.3          
#>  [85] compiler_4.0.3       shinythemes_1.2.0    rstudioapi_0.13     
#>  [88] png_0.1-7            curl_4.3.2           gamm4_0.2-6         
...
#> [103] tensorA_0.36.1       vctrs_0.3.8          pillar_1.7.0        
...
#> [121] shinystan_2.5.0      mgcv_1.8-33          hms_1.1.1           
...
#> notebook            6.4.8
#> -----
#> Python 3.8.8 (default, Apr 13 2021, 20:00:26) [GCC 7.3.0]
#> Linux-5.13.0-35-generic-x86_64-with-glibc2.10
#> -----
#> Session information updated at 2022-03-21 20:03
```
