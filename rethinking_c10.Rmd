...
There is no homework in chapter 10 `r emo::ji("smile")`.

## {brms} section

There are no new model in this chapter that would need to be translated to {brms} `r emo::ji("shrug")`.
