...
Halfing a states marriage rate would on average increase the divorce rate by ~ `r round(mean(data_sim2$diff, digits = 2))` standard deviations.
...
$\rightarrow$ there are only three *house* levels `r emo::ji("face_with_raised_eyebrow")`.
